...
<body>
	<div id="total">
		...
		<div id="center">
			<h3>회원 가입</h3>
			<form action="insert.jsp" autocomplete=off>
			...
			<hr>
			<h3>회원 탈퇴</h3>
			<form action="delete.jsp" autocomplete=off>
				ID: <input name="id"><br>
			...
			<hr>
			<h3>회원 수정</h3>
			<form action="update.jsp" autocomplete=off>
				ID: <input name="id"><br> 
			...
			<hr>
			<h3>회원 검색</h3>
			<form action="read.jsp" autocomplete=off>
				ID: <input name="id"><br>
